...
namespace Nexus.Archive
{
    ...
    {
        public Archive(IndexFile index, ArchiveFile archive)
        {
            IndexFile = index;
            ArchiveFile = archive;
        }
        ...
        public Stream OpenFileStream(IArchiveFileEntry fileEntry, bool handleCompression = true)
        {
            ...
            if (ArchiveFile != null)
                baseStream = ArchiveFile.Open(fileEntry);
            else
                baseStream = OpenLocalFile(fileEntry.Path);
        ...
        public static Archive FromFile(string name)
        {
            string baseName;
            ...
            return new Archive(indexFile, archiveFile);
        }
    }
}